...
cAndroidSystemClockSensorEventSampleInvervalStabilityFileName = strcat('AndroidSystemClock',cSensorSplit{1},'SampleInvervalStability',cPhoneSplit{1},cPhoneSplit{2},'.png');

function [outputFilterState] = filterKITTIPropagateUpdate3DNHCImuMeasurement(inputFilterState,inputImuMeasurement)
...
measurementCovarianceR = diag([100,100,100]);
measurementError = inputPseudoMeasurementForwardVelocity - updateStateCarVelocityInCar;

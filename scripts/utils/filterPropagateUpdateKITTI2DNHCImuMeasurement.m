function [outputFilterState] = filterPropagateUpdateKITTI2DNHCImuMeasurement(inputFilterState,inputImuMeasurement)
...
% measurementCovarianceR = diag([1,3]).^2;
% measurementCovarianceR = diag([70,100]);
measurementCovarianceR = diag([1,10]);
measurementError = - updateStateCarVelocityInCar([2 3]);

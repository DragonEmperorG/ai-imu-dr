function [] = plotKITTIGroundTruthGeodeticCoordinate(importFolderPath, exportFolderPath)
%UNTITLED 此处提供此函数的摘要
%   此处提供详细说明

TAG = 'plotKITTIGroundTruthGeodeticCoordinate';

tOxtsRawData = loadOxtsRawData(importFolderPath);
tOxtsRawDataLatitude = tOxtsRawData(:,2);
tOxtsRawDataLongitude = tOxtsRawData(:,3);
% tOxtsRawDataAltitude = zeros(size(tOxtsRawData(:,4)));
...
cKITTIOdometryPreviewFilePath = fullfile(exportFolderPath,'KITTIOdometryPreview.png');
